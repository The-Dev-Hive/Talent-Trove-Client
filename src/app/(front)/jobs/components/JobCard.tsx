      ...
      <div className="lg:w-1/4 w-full p-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
          ...
          <div className="flex justify-between flex-row lg:flex-col mb-6">
            ...
            {/* Remote Only Toggle with ON/OFF label */}
            <div className="flex flex-col w-full">
...
//   return (
//     <div className=" pt-16 pb-12 flex justify-between  flex-col-reverse mx-auto  max-w-7xl lg:flex-row lg:space-x-6">
//       {/* Main Content */}
//       <div className="lg:w-3/4 w-full flex flex-col mt-12">
//         {/* Search Bar */}
...
//           <button
//             type="submit"
//             className="ms-2 py-2.5 px-3 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none"
//           >
//             Search
//           </button>
//         </div>
...
//         {/* Title */}
//         <h1 className="px-4 text-2xl font-bold mb-4">Latest Jobs</h1>
...
//             <div
//               key={idx}
//               className="flex flex-col p-4 lg:p-6 rounded-lg border border-gray-200 shadow-sm hover:bg-indigo-100 transition-shadow duration-300"
//             >
//               <div className="flex items-center justify-between mb-4">
//                 <div className="flex items-center gap-2">
//                   <div className="w-10 h-10 bg-gray-200 rounded-full flex justify-center items-center">
...
//                 </div>
//               </div>
//               <div className="flex items-center text-gray-600 space-x-4 text-sm mb-4">
//                 <div className="flex items-center gap-2">
//                   <FaShoppingBag className="h-5 w-5 text-blue-500" />
//                   <span className="font-medium">Segment</span>
//                 </div>
...
//       {/* Sidebar */}
//       <div className="lg:w-1/4   w-full lg:sticky lg:top-20 p-4 lg:pb-8 bg-white rounded-lg shadow-md border border-gray-200 lg:h-full">
//   <p className="text-indigo-600 text-xl font-bold mb-2">Filters Jobs</p>

//   <div className="lg:grid lg:grid-cols-1 grid grid-cols-2 gap-4 mb-6">
//     <div>
...
//         <label className="inline-flex items-center">
//           <input type="checkbox" className="form-checkbox text-blue-600" />
//           <span className="ml-2 text-gray-700">Co-founder</span>
//         </label>
//       </div>
//     </div>

//     <div>
//       <h3 className="font-bold text-lg mb-4">Job Roles</h3>
//       <div className="flex flex-col space-y-2">
//         <label className="inline-flex items-center">
//           <input type="checkbox" className="form-checkbox text-blue-600" />
...
//     </div>
//   </div>
// <div className=" grid grid-cols-2 lg:grid-flow-col"></div>

//   <div className=" flex flex-col gap-4 mb-6 mt-6">
//     <div className=" ">
//       <h3 className="font-bold">Remote Only</h3>
//       <div
//         className={`${
//           isToggle ? "bg-primary border-primary" : "  border-gray-200"
//         } border relative p-1 rounded-full w-[55px] cursor-pointer transition-all h-[30px]`}
//         onClick={handleSwitchChange}
//       >
//         <div className="absolute inset-0 flex items-center justify-center">
//           <div
//             className={`${
//               isToggle ? "translate-x-[13px]" : "translate-x-[-13px]"
//             } w-[22px] h-[22px] rounded-full   bg-indigo-500 transition-all duration-200`}
//           ></div>
//         </div>
//       </div>
...
//   <div className="p-5 mt-6 border-t border-gray-200">
//     <label htmlFor="location" className="mb-2 font-bold text-gray-700">
//       Location
//     </label>
//     <select id="location" className="p-2 border border-gray-300 rounded-md w-full">
//       <option value="">Anywhere</option>
